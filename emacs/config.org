...
(use-package helm
  ...
  :config (helm-mode)  ;; enable `helm' for everything by default
  :bind (("M-x" . helm-M-x)
...
(add-hook 'after-make-frame-functions
          (lambda () (when (display-graphic-p) (require 'ace-window))))
#+end_src
...
(use-package julia-formatter
  :straight (julia-formatter :host nil
                             :type git
...
(use-package org
  ...
  :config
  ;; Unbind the M-RET keybinding for `org-meta-return'. I sometimes use this keybinding for
  ;; copilot completetions, etc. + `org-meta-return' is functionality we already have bindings for.
  (unbind "M-RET" org-mode-map)
  (unbind "<M-return>" org-mode-map)
...
(defun tor/enable-theme-after (theme)
  ...
  ;; NOTE: you stupid boy. You can just use `pdf-view-themed-minor-mode'...
