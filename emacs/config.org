...
#+begin_src emacs-lisp 
(use-package compat
  ;; :straight (compat :type git :host github :repo "emacs-compat/compat" :branch "28.1.2.2")
  )
#+end_src
** Result
#+name: basics
...
(use-package julia-formatter
  ...
  ;; :hook
  ;; (julia-mode . julia-formatter-mode)s
  :custom
...
(use-package graphviz-dot-mode
  :ensure t
  :hook
  (company-mode . graphviz-dot-mode)
  :config
