...
#+name: el-load-custom-settings-v2
#+begin_src emacs-lisp
...
** Programming & Markup
*** isend
#+name: el-pkg-isend-mode-v2
#+begin_src emacs-lisp
(use-package isend-mode)
#+end_src
*** Flycheck
#+name: el-pkg-flycheck-v2
#+begin_src emacs-lisp
...
** Extras
*** Julia
#+name: el-pkg-julia-mode-v2--simple
...
#+begin_src emacs-lisp :noweb yes :tangle init-terminal.el
<<el-basic-utility-functions>>

<<el-basic-variables-v2>>

<<el-backup-v2>>

<<el-load-custom-settings-v2>>

<<el-straight-setup-v2>>
...
<<el-pkg-projectile-v2>>

<<el-pkg-treemacs-v2>>

<<el-git-v2>>

<<el-pkg-smartparens-v2>>

<<el-pkg-undo-tree-v2>>

<<el-pkg-company-v2>>

<<el-pkg-isend-mode-v2>>
...
<<el-pkg-julia-mode-v2--simple>>

<<el-python-v2--simple>>

<<el-pkg-jupyter-v2>>

<<el-pkg-lsp-v2--simple>>

<<el-pkg-org-v2--simple>>

<<el-ansi-color-codes-handling>>
#+end_src
